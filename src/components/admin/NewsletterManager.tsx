  ...
  return (
    ...
    >
      ...
      <Dialog open={openCampaignDialog} onOpenChange={setOpenCampaignDialog}>
        <DialogContent className="bg-dark-500 border-dark-400 text-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-white/60">
              Kampanya bilgilerini düzenleyebilirsiniz.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-white/50">Alıcının gelen kutusunda görünecek konu.</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                ...
                className="bg-dark-400 border-dark-300 resize-none text-white h-48"
                placeholder="Kampanya içeriği (HTML desteklenir)"
              />
              <p className="text-xs text-white/50">HTML içerik ekleyebilirsiniz. Örneğin: {'<h1>Başlık</h1><p>Paragraf</p>'}</p>
            </div>
      ...
      <Dialog open={openTemplateDialog} onOpenChange={setOpenTemplateDialog}>
        <DialogContent className="bg-dark-500 border-dark-400 text-white">
          <DialogHeader>
            <DialogTitle>{isEditing ? 'Şablon Düzenle' : 'Yeni Şablon Ekle'}</DialogTitle>
            <DialogDescription className="text-white/60">
              Şablon bilgilerini düzenleyebilirsiniz.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-white/50">Yer tutucular için {'{{değişken}}'} formatını kullanabilirsiniz.</p>
            </div>
            
            <div className="space-y-2">
              <label className="text-sm font-medium text-white">İçerik Şablonu</label>
              <Textarea 
                value={currentTemplate.content || ''} 
                onChange={(e) => setCurrentTemplate({...currentTemplate, content: e.target.value})}
                className="bg-dark-400 border-dark-300 resize-none text-white h-48"
                placeholder="<h1>{{başlık}}</h1><p>{{içerik}}</p><footer>{{iletişim}}</footer>"
              />
              <p className="text-xs text-white/50">HTML ve yer tutucular kullanabilirsiniz. Örnek: {'<h1>{{başlık}}</h1><p>{{içerik}}</p>'}</p>
            </div>
          </div>
